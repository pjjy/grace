...
class _NavDrawerExample extends State<NavDrawerExample> {
  ...
  void onCalledFromOutside() async {
    var response = await sqlLite.fetcHistory();
    setState(() {
      courseData = response;
      print(courseData);
        ...
        children: <Widget>[
          ...
          ListTile(
            ...
            onTap: () {
              ...
              Navigator.of(context).push(
                  _NewPage(1, courseData, fetchUserData, onCalledFromOutside));
            },
          ),
          ListTile(
            ...
            onTap: () {
              Navigator.of(context).pop(); // Close the drawer
              // Navigator.of(context).push(
              //     _NewPage(2, courseData, fetchUserData, onCalledFromOutside));
              Navigator.of(context).push(
                MaterialPageRoute(
                  builder: (context) => AnotherPage(2),
                ),
              );
            },
          ),
          ListTile(
            ...
            onTap: () {
              Navigator.of(context).pop(); // Close the drawer
              Navigator.of(context).push(
                  _NewPage(3, courseData, fetchUserData, onCalledFromOutside));
              // Add your logic
            },
          ),
        ],
...
class AnotherPage extends StatefulWidget {
  ...
  AnotherPage(this.id);
  @override
  _AnotherPage createState() => _AnotherPage();
}
...
class _AnotherPage extends State<AnotherPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          if (widget.id == 3) // Conditionally render for page 3 only
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: Column(
                children: [
                  ...
                  const SizedBox(
                      height: 8), // Add space between text and additional text
                  const Text(
            ...
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return ListTile(
                    title: Text(courseData[index]["courseName"].toString()),
                    trailing: Wrap(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Container(
                        ...
                        color: const Color.fromRGBO(
                            171, 147, 112, 1), // Example background color
                        child: Center(
                          child: Column(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
...
class _NewPage extends MaterialPageRoute<void> {
  ...
  _NewPage(this.id, this.courseData, this.fetchUserData, this.callback)
      : super(
